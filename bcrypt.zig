// Temporary measure to fix a speed issue in the bcrypt stdlib
// TODO: Remove this when the bcrypt lib is fixed in a release
...
pub const State = struct {
    ...
    fn feistelF(state: *const State, x: u32) u32 {
